...
export const NAV_ITEMS = [
  ...
  { href: "/dashboard/knowledge",          label: "Motor de Conhecimento", icon: BookOpen,        exact: false,
    info: "Motor científico curado: 30+ artigos com DOI, 20+ patentes (WIPO/USPTO), 15+ metodologias com links reais para PubMed/Nature/JoVE. Busque por nome, filtre por tipo (Artigos/Patentes/Metodologias) e categoria. Faça upload dos seus próprios documentos — a BIA os usa para responder com mais contexto." },
