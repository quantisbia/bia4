...
import { GitBranch, Plus, CheckCircle2, Circle, Clock, Loader2, Zap, ArrowRight } from "lucide-react"
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-1">
          {loading ? (
            ...
            <div className="py-8 text-center">
              ...
              <p className="text-xs text-gray-500">Nenhum projeto ainda</p>
            </div>
          ) : (
            projects.map((p) => (
              <button
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {showCreate ? (
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="w-full max-w-md bg-white/2 border border-white/8 rounded-2xl p-6">
              <h3 className="text-lg font-semibold text-white mb-1">Novo Projeto de Pipeline</h3>
              <p className="text-sm text-gray-400 mb-6">Configure os parâmetros do seu projeto de design de tecido</p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { key: "cellSource", label: "Fonte celular (opcional)", placeholder: "ex: iPSC humana" },
                ].map((field) => (
                  <div key={field.key}>
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/40 focus:ring-1 focus:ring-emerald-500/20"
                    />
                  </div>
                ))}
          ...
          <div className="flex-1 overflow-y-auto p-6">
                  ...
                  <div
                    ...
                    className={`relative rounded-xl border p-4 transition-all ${
                      isCompleted
                        ...
                        : isCurrent
                        ? "border-blue-500/30 bg-blue-500/5 ring-1 ring-blue-500/15"
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {isCurrent && (
                          <button
                            onClick={() => analyzeStage(stage.num)}
                            disabled={analyzing}
            ...
            {analysis && (
              <div className="rounded-2xl border border-blue-500/20 bg-blue-500/3 p-6">
                ...
                <p className="text-sm text-gray-300 leading-relaxed mb-4">{analysis.recommendation}</p>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Pipeline de Design de Tecidos</h3>
              <p className="text-sm text-gray-500 max-w-xs mx-auto mb-6">
                Selecione um projeto existente ou crie um novo para começar o pipeline de 12 etapas assistido por IA.
              </p>
              <button
                onClick={() => setShowCreate(true)}
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-500 text-white text-sm font-semibold hover:bg-emerald-400 transition-colors mx-auto"
              >
