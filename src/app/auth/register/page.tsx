        ...
        <div className="mt-4 p-3.5 rounded-xl bg-white/[0.02] border border-white/8">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              // R13.03.2: Academy R$ 4.970 · 6 meses ESCONDIDO (formato descontinuado).
              // Novo curso Academy: R$ 2.375 online · 12 meses — vendido em /academy.
              // O plano ACADEMY continua no enum para alunos que compram o curso.
