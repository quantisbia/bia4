...
export const BIOPRINTERS: BioprinterSpec[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    brand: "BIOEDTECH",
    model: "BioEnder",
    fullName: "BIOEDTECH BioEnder — adaptação estratégica da Creality Ender 3 para biofabricação",
    ...
    priceTier: "academic",
    description:
      "Bioimpressora nacional com a melhor relação custo-benefício do mercado. Nasceu de uma adaptação estratégica e inteligente da Creality Ender 3 — a plataforma FDM de código aberto mais difundida do mundo — convertida pela BIOEDTECH em equipamento de bioimpressão pneumática com cabeçote refrigerado, mesa aquecida e firmware Marlin/Klipper aberto. Totalmente compatível com o ecossistema da área (Cura, Pronterface, OctoPrint, Repetier) e otimizada nativamente para a BIA: o G-code RepRap/Marlin padrão gerado pelo BIA roda direto via Web Serial USB, sem conversores ou drivers proprietários.",
    typicalApplications: [
      "Ensino e treinamento universitário",
      "Pesquisa acadêmica de baixo custo",
      "Scaffolds FDM (PCL, PLA, PLGA)",
      "Hidrogéis pneumáticos (alginato, GelMA, colágeno)",
      "Validação de protocolos antes de migrar para CELLINK/Allevi",
    ],
    notes: [
      "✅ G-code da BIA roda direto (sem conversão) — RepRap/Marlin padrão",
      "✅ Conexão USB-B Web Serial (baud 115200) — controle nativo pelo painel da BIA",
      "✅ Firmware Marlin/Klipper aberto — totalmente customizável",
      "✅ Compatível com Cura, Pronterface, OctoPrint, Repetier-Host",
      "✅ Comunidade global Ender 3 — peças, mods e suporte abundantes",
      "💰 ~10× mais barata que bioimpressoras profissionais equivalentes",
      "🇧🇷 Suporte técnico em português pela BIOEDTECH",
    ],
    icon: "🇧🇷",
  },
  {
